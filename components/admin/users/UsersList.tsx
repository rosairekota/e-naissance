    ...
    <div className="rounded-xl  bg-white px-5 pt-6 pb-2.5  dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left text-black dark:bg-meta-4">
              <th className="min-w-[220px] py-4 px-4 font-medium  dark:text-white xl:pl-11">
                Noms
              </th>
              <th className="min-w-[150px] py-4 px-4 font-medium  dark:text-white">
                Type
              </th>
              <th className="min-w-[120px] py-4 px-4 font-medium  dark:text-white">
                Marchant
              </th>
              <th className="min-w-[120px] py-4 px-4 font-medium  dark:text-white">
                Status
              ...
              <th className="py-4 px-4 font-medium  dark:text-white">
                Actions
              </th>
            </tr>
          </thead>
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <p className=" dark:text-white">
                    { !user.isMerchant ?'User Support':'U-marchant'}
                  </p>
                </td>
                { !user.isMerchant ?(
                   <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
