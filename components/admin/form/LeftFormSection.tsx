...
const GeometricShape = () => (
  ...
  >
    <div
      ...
      className="relative left-[calc(50%-11rem)] aspect-[1155/678] w[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-primary-800 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] opacity-30"
    />
  </div>
);
